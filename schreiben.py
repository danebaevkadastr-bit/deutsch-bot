...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    await update.message.reply_text("Aufgabe tanlang 👇", reply_markup=main_menu)
...
async def show_tasks(update: Update, context: ContextTypes.DEFAULT_TYPE):
    await update.message.reply_text("Aufgabe tanlang:", reply_markup=build_buttons())
...
async def text_router(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if text in ["✍️ Matn yuborish", "📸 Rasm yuborish"]:
        await update.message.reply_text("Endi yuboring")
        return
